...
void loop() {
  ...
  Serial.println("give motor little jerk delay started ");
  servo1.write(20);
  delay(2000);
  Serial.println("give motor little jerk delay finished ");
